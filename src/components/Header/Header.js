    ...
    return (
        <div>
            ...
            <nav className='bg-gray-500 py-3 flex justify-center'>
                ...
                <CustomLink to='/posts' className='mr-8 text-orange-400 font-semibold hover:text-purple-700 text-xl bg-green-200 px-3 py-1 rounded-lg'>Posts</CustomLink>
                <CustomLink to='/countries' className='mr-8 text-orange-400 font-semibold hover:text-purple-700 text-xl bg-green-200 px-3 py-1 rounded-lg'>Countries</CustomLink>
